        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'gradeId', title: '年级名', width: 150, sortable: true,
            ...
            $("#delete").click(function () {
                ...
                if (selectLength == 0) {
                    ...
                    $.messager.confirm("消息提醒", "班级下存在学生信息将无法删除，确认继续？", function (r) {
                        if (r) {
                            $.ajax({
                                type: "post",
                                url: "/clazz/delete",
                        ...
                        handler: function () {
                            ...
                            if (!validate) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        if (data.type == "success") {
                                            $.messager.alert("消息提醒", "添加成功!学生添加该班级需要刷新！", "info");
                                            //关闭窗口
...
<div id="toolbar">
    ...
    <div>
        ...
        年级名：<select id="search-grade-id" class="easyui-combobox" style="width: 150px;">
                <option value="">全部</option>
                <c:forEach var="grade" varStatus="status" items="${gadeList}">
    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="8">
            <tr>
                ...
                <td>
                    <input id="add_name" class="easyui-textbox" style="width: 200px; height: 30px;" type="text"
                           name="name" data-options="required:true, missingMessage:'请输入用户名'"/>
                </td>
            </tr>
            <tr>
                <td>所属年级:</td>
            ...
            <tr>
                <td>备注:</td>
                <td>
                    <input id="add_remark" class="easyui-textbox" style="width: 200px; height: 150px;" name="remark"
    ...
    <form id="editForm" method="post">
        <table id="editTable" border=0 cellpadding="8">
            ...
            <tr>
                <td>备注:</td>
                <td>
                    <input id="edit_remark" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="remark"/>
                </td>
            </tr>
        </table>
